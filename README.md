...
* [Temporal Reprojection Anti-Aliasing in INSIDE (Slides)](http://s3.amazonaws.com/arena-attachments/655504/c5c71c5507f0f8bf344252958254fb7d.pdf?1468341463)
...
* [Reconstruction Filters in Computer Graphics (Paper)](https://www.cs.utexas.edu/~fussell/courses/cs384g-fall2013/lectures/mitchell/Mitchell.pdf)
* [Filmic SMAA (Slides)](https://advances.realtimerendering.com/s2016/Filmic%20SMAA%20v7.pptx)
* [HRAA (Slides)](https://michaldrobot.com/2014/08/13/hraa-siggraph-2014-slides-available/)
* [AMD FSR (Slides)](https://advances.realtimerendering.com/s2021/Unity%20AMD%20FSR%20-%20SIGGRAPH%202021.pdf)
* [Software VRS with Visibility Buffer Rendering (Blog Post)](http://filmicworlds.com/blog/software-vrs-with-visibility-buffer-rendering/)
* [Low-resolution effects with depth-aware upsampling (Blog Post)](https://c0de517e.blogspot.com/2016/02/downsampled-effects-with-depth-aware.html)
* [Fast rendering of opacity-mapped particles using DirectX 11 tessellation and mixed resolutions (PDF)](https://developer.download.nvidia.com/assets/gamedev/files/sdk/11/OpacityMappingSDKWhitePaper.pdf)
* [Lanczos 2D Correctly (Blog Post)](https://github.com/pixelflinger/lanczos-2d)
* [PBRT Image Reconstruction (Chapter)](https://www.pbr-book.org/4ed/Sampling_and_Reconstruction/Image_Reconstruction)
